...
class AuthUser(models.Model):
    ...
    identificacion = models.CharField(max_length=150, blank=True, null=True)
...
class Mandato(models.Model):
    ...
    abreviacion = models.CharField(max_length=150, blank=True, null=True)
